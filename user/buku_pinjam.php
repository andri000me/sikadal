			...
			<div class="page-content">
				...
				<div class="card">
					<div class="card-body">
                     ...
                     <?php
                     $query = mysqli_query($mysqli,"SELECT peminjaman.id_brg, peminjaman.id_user, peminjaman.tgl_pinjam, peminjaman.status, barang.nama_brg, barang.jenis_brg, barang.foto FROM peminjaman JOIN barang ON peminjaman.id_brg=barang.id_brg JOIN user ON user.id_user=peminjaman.id_user");
                     $id_peminjam=1;
