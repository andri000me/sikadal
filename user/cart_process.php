...
############# Memasuk produk baru ke keranjang pinjaman #########################
...
################## List Produk yang ada di keranjang pinjaman ###################
if(isset($_POST["load_cart"]) && $_POST["load_cart"]==1)
{
	...
	if(isset($_SESSION["products"]) && count($_SESSION["products"])>0){ 
		...
		die("Keranjang Pinjaman Anda Kosong"); 
	}
}

################# Menghapus Item dari Keranjang Pinjaman ################
